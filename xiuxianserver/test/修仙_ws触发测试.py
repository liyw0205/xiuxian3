...
async def main_async() -> None:
    ...
    with TemporaryDirectory() as temp_dir:
        ...
        try:
            ...
            _must_reply(manager, "player_ws", "辨灵试色")
            _must_reply(manager, "player_ws", "/static/dongtian/bianling-color/index.html")
            ...
            _must_reply(manager, "player_ws", "坠渊百层")
            _must_reply(manager, "player_ws", "/static/dongtian/zhuiyuan-hundred-floor/index.html")
