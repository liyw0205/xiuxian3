...
@WsMessageHandler.handler(cmd="升级源库", priority=100, block=True)
...
@WsMessageHandler.handler(cmd="存入源石", priority=100, block=True)
...
@WsMessageHandler.handler(cmd="取出源石", priority=100, block=True)
