...
@WsMessageHandler.handler(cmd=("二手市场", "二手"), priority=100, block=True)
...
@WsMessageHandler.handler(cmd=("二手市场上架", "上架二手市场", "二手上架"), priority=100, block=True)
...
@WsMessageHandler.handler(cmd=("二手市场下架", "下架二手市场", "二手下架"), priority=100, block=True)
...
@WsMessageHandler.handler(cmd=("二手市场购买", "购买二手市场", "二手购买"), priority=100, block=True)
