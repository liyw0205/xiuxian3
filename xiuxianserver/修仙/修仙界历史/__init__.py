...
async def ws_history_leaderboard(client_id: str) -> None:
    """查看风云榜。"""
...
async def ws_history_morning_paper(client_id: str) -> None:
    """查看今日修仙早报。"""
...
async def ws_history_chronicle(client_id: str) -> None:
    """查看最近修仙界历史。"""
...
async def ws_history_player_volume(client_id: str) -> None:
    """查看人物史榜。"""
...
async def ws_history_sect_volume(client_id: str) -> None:
    """查看宗门史榜。"""
...
async def ws_history_city_volume(client_id: str) -> None:
    """查看城池史榜。"""
...
async def ws_history_battle_volume(client_id: str) -> None:
    """查看战斗名局。"""
...
async def ws_history_trade_volume(client_id: str) -> None:
    """查看商路奇闻。"""
...
async def ws_history_wormhole_volume(client_id: str) -> None:
    """查看异界虫洞录。"""
...
async def ws_history_profile(client_id: str, message: str) -> None:
    """查看公开人物志。"""
