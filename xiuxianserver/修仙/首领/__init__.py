...
async def ws_seasonal_boss_status(client_id: str) -> None:
    """查看今日岁时情劫。"""
...
async def ws_seasonal_boss_state(client_id: str) -> None:
    """查看今日岁时情劫状态。"""
...
async def ws_seasonal_boss_challenge(client_id: str) -> None:
    """挑战今日岁时情劫。"""
...
async def ws_seasonal_boss_ranking(client_id: str) -> None:
    """查看岁时情劫伤害排行。"""
...
async def ws_seasonal_boss_reward(client_id: str) -> None:
    """领取岁时情劫贡献奖励。"""
