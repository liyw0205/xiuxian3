...
async def ws_wormhole_status(client_id: str) -> None:
    """查看当前异界虫洞。"""
...
async def ws_wormhole_state(client_id: str) -> None:
    """查看当前异界虫洞状态。"""
...
async def ws_wormhole_challenge(client_id: str) -> None:
    """挑战当前虫洞 Boss。"""
...
async def ws_wormhole_ranking(client_id: str) -> None:
    """查看虫洞伤害排行。"""
...
async def ws_wormhole_reward(client_id: str) -> None:
    """领取虫洞贡献奖励。"""
