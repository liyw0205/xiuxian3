...
async def ws_profile(client_id: str) -> None:
    """查看玩家详细信息。"""
...
async def ws_status(client_id: str) -> None:
    """查看玩家关键状态。"""
...
async def ws_player_diary(client_id: str) -> None:
    """查看个人修仙日记。"""
...
async def ws_sign(client_id: str) -> None:
    """每日签到。"""
...
async def ws_newbie_gift(client_id: str) -> None:
    """领取新手礼包。"""
...
async def ws_rest(client_id: str) -> None:
    """进入休息状态。"""
...
async def ws_end_rest(client_id: str) -> None:
    """结束休息并恢复。"""
