...
- 纯经济只包含当前 11 个普通跑商地区各 3 个特产，共 33 个；区域主题地点和其他世界物资大类不能塞进纯经济。
...
trade_prices                跑商价格
trade_heat                  跑商热度
trade_industry_states       地点行业状态保留表，当前不由跑商特产驱动
...
- `combat_logs` 保留 7 天，只保留旧式短战斗流水；网页战斗日志优先读取探险、对战、抢劫、首领挑战和虫洞挑战的结构化结果。
...
武器、宝石、技能书出售统一走商场入口：`出售 物品名 数量` 或 `出售全部 武器/宝石/技能书`。
