...
TRADE_DAILY_PLAYER_SOFT_SHARE_MULTIPLIER = 1.5
TRADE_DAILY_PROFIT_MIN_RATE = 0.35
TRADE_FATIGUE_PROFIT_RATE = 0.15
TRADE_FATIGUE_MIN_PROFIT_RATE = 0.08
TRADE_FATIGUE_PRESSURE_FACTOR = 0.8
TRADE_FATIGUE_SOFT_SHARE_MULTIPLIER = 2.0
