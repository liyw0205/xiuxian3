...
async def ws_current_location(client_id: str) -> None:
    """查看当前位置。"""
...
async def ws_exploration_locations(client_id: str) -> None:
    """查看探险地点。"""
...
async def ws_exploration_status(client_id: str) -> None:
    """查看探险状态。"""
...
async def ws_exploration_claim(client_id: str) -> None:
    """领取探险结果。"""
...
async def ws_exploration_records(client_id: str) -> None:
    """查看探险记录。"""
