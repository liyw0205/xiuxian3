...
NAMES = {
    # 地点体系：系统自带的 NPC 地点、普通城池、秘境、特殊收购点、回收点都在这里换名。
    "places": {
    ...
    "actors": {
        ...
        # 玩家体质名：强绑定一整套体质设定，换皮时建议整组一起改，避免风格割裂。
        "physiques": {
            "fanti": "凡体",
            "qingfeng_lingti": "清风灵体",
            "houde_lingti": "厚土灵体",
            "lingquan_ti": "灵泉体",
            "tiegu_ti": "铁骨体",
            "mingxin_ti": "明心体",
            "qianye_lingti": "千叶灵体",
            "qingmu_xuanti": "青木玄体",
            "xuanbing_linggu": "玄冰灵骨",
            "chixia_lingti": "赤霞灵体",
            "leiwenzhanti": "雷纹战体",
            "yuyue_ti": "玉月体",
            "jianxin_xuangu": "剑心玄骨",
            "longxiang_baoti": "龙象宝体",
            "xinghe_lingti": "星河灵体",
            "taiyin_yuti": "太阴玉体",
            "taiyang_yanti": "太阳炎体",
            "canghai_daoti": "沧海道体",
            ...
            "hunyuan_daoti": "玄黄镇岳体",
            "wugou_xianji": "琉璃无垢体",
            "wanxiang_lingtai": "千幻游身体",
            "zifu_tianti": "紫府明神体",
            "qianqiu_jianmai": "千秋剑脉",
            "shenxiao_leiti": "神霄雷体",
            "xiantian_daotai": "先天药胎",
            "canglong_shengti": "苍龙圣体",
            "jiuyao_shengti": "九曜星命体",
            "bumie_jinshen": "不灭金身",
            "taixu_xianmai": "太虚仙脉",
            "hongmeng_xuanti": "归墟玄体"
        },
